        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                year: "2018",
                text: "Founded with a small fleet and a big vision."
              },
              {
                year: "2020",
                text: "Expanded services across multiple states."
              },
              {
                year: "2024",
                text: "Trusted by 1200+ satisfied customers."
              }
            ].map((item, i) => (
              <motion.div
                key={i}
                ...
                className="bg-gray-100 p-8 rounded-xl shadow-md text-center"
              >
                <h3 className="text-2xl font-bold text-yellow-500">
                  {item.year}
                </h3>
