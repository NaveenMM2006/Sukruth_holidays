  ...
  return (
    <div className="bg-gray-100 overflow-x-hidden">
      ...
      <div className="relative bg-slate-900 text-white py-16 md:py-20 overflow-hidden">
        ...
        {/* Road */}
        <div className="absolute bottom-8 md:bottom-10 w-full h-3 md:h-4 bg-gray-700">
        ...
        <motion.div
          ...
          className="absolute bottom-10 md:bottom-12 text-4xl md:text-5xl"
        >
          🚐
        </motion.div>
      ...
      <div className="py-12 md:py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 text-center">
          ...
          {[
            ...
            <motion.div
              ...
              className="bg-gray-100 p-6 md:p-8 rounded-2xl shadow-lg"
            >
      ...
      <motion.div
        ...
        transition={{ duration: 0.6 }}
        className="bg-yellow-400 py-10 md:py-14 text-center px-4"
      >
